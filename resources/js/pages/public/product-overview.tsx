                    ...
                    <>
                        ...
                        <div className="grid gap-8 lg:grid-cols-2">
                            ...
                            <div className="space-y-4">
                                <Card className="flex aspect-square items-center justify-center overflow-hidden bg-neutral-100 dark:bg-neutral-800">
                            ...
                            <div className="border-b border-neutral-200 dark:border-neutral-800">
                                <nav className="-mb-px flex gap-8">
                                    {[
                                        ...
                                        {
                                            key: 'reviews',
                                            label: `Reviews (${product.total_reviews})`,
                                        },
                                    ].map((tab) => (
                                        <button
                                            key={tab.key}
                                        ...
                                        <CardContent className="p-6">
                                            ...
                                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                                {[
                                                    ...
                                                    <div
                                                        key={key}
                                                        className="flex justify-between border-b py-3 dark:border-neutral-800"
                                                    >
                                            ...
                                            0 ? (
                                                ...
                                                <div className="space-y-6">
                                                    {[1, 2, 3].map((review) => (
                                                        <div
                                                            key={review}
                                                            className="border-b pb-6 last:border-0 last:pb-0 dark:border-neutral-800"
                                                        >
