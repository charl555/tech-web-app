            ...
            <div className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
                ...
                {!inStock ? (
                    ...
                    <div className="grid gap-8 lg:grid-cols-2">
                        <div className="space-y-4">
                            <Card className="flex aspect-square items-center justify-center bg-neutral-100 dark:bg-neutral-800">
                ...
                <div className="mt-12 space-y-4">
                    <Collapsible
                        ...
                        onOpenChange={(isOpen) =>
                            setOpenSection(isOpen ? 'description' : null)
                        }
                    >
                    ...
                    <Collapsible
                        ...
                        onOpenChange={(isOpen) =>
                            setOpenSection(isOpen ? 'specifications' : null)
                        }
                    >
                        <CollapsibleTrigger className="flex w-full items-center justify-between rounded-lg border p-4 text-left">
                        ...
                        <CollapsibleContent className="mt-2 rounded-lg border p-4">
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                {[
                                    ...
                                    <div
                                        key={key}
                                        className="flex justify-between border-b py-2 dark:border-neutral-800"
                                    >
                    ...
                    <Collapsible
                        ...
                        onOpenChange={(isOpen) =>
                            setOpenSection(isOpen ? 'reviews' : null)
                        }
                    >
                        <CollapsibleTrigger className="flex w-full items-center justify-between rounded-lg border p-4 text-left">
                            <span className="font-semibold">
                            ...
                            {Number(product.total_reviews) === 0 ? (
                                ...
                                <div className="space-y-4">
                                    {[1, 2, 3].map((review) => (
                                        <div
                                            key={review}
                                            className="border-b pb-4 last:border-0 last:pb-0 dark:border-neutral-800"
                                        >
                                            ...
                                            <p className="mt-2 text-sm text-neutral-600 dark:text-neutral-400">
                                                Great product! Exactly what I
                                                was looking for. Fast shipping
                                                and excellent quality. Would
