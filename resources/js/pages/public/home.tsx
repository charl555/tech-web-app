...
export default function Home({ featuredProducts }: HomeProps) {
    return (
        <>
                    ...
                    <div className="grid items-center gap-8 lg:grid-cols-2">
                        <div className="space-y-6">
                            ...
                            <p className="text-lg text-neutral-600 dark:text-neutral-400">
                                Shop the latest CPUs, GPUs, motherboards, and
                                more. Quality components from top brands,
                            ...
                            <div className="flex items-center gap-6 pt-4 text-sm text-neutral-600 dark:text-neutral-400">
                                ...
                                <div className="flex items-center gap-2">
                                    <Shield className="h-4 w-4" />2 Year
                                    Warranty
                                </div>
                                <div className="flex items-center gap-2">
                        ...
                        <div className="relative flex items-center justify-center lg:justify-end">
                            {/* Subtle Nitro Blue Glow Backlight */}
                            <div
                                aria-hidden="true"
                                className="absolute -inset-4 rounded-full bg-sky-500/20 blur-3xl dark:bg-sky-500/10"
                            />

                            {/* Hero Card Frame */}
                            <div className="relative aspect-square w-full max-w-md overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-xl dark:border-neutral-800 dark:bg-neutral-900/80 dark:shadow-2xl">
                                <img
            ...
            <section className="border-t py-16 dark:border-neutral-800">
                <div className="mx-auto max-w-7xl px-4 lg:px-8">
                    <Card className="bg-fff text-neutral-50 dark:bg-neutral-800">
                        <CardContent className="flex flex-col items-center justify-between gap-6 p-8 text-center md:flex-row md:text-left">
                            <div className="space-y-2">
                                ...
                                <p className="text-neutral-700 dark:text-neutral-400">
                                    Get up to 30% off on selected GPUs and CPUs.
                                    Limited time offer.
                                </p>
                            </div>
                            <Link href="/products">
